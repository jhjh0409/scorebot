...
class TemplateManager:
    ...
    def __init__(self, template_dir: Optional[str] = None):
        ...
        Args:
            template_dir (Optional[str]): Directory containing Jinja templates.
                Defaults to the templates directory bundled with this package,
    ...
    def _load_templates(self):
        ...
        template_files = {
            ...
            "preset_evaluation_criteria": "preset_evaluation_criteria.jinja",
            "preset_evaluation_system_message": "preset_evaluation_system_message.jinja",
        }
